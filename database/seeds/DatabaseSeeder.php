...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('teachers')->insert(['pic' => 'images/teachers/mohammadi.jpg','name' => 'استاد محمدی','title' => 'مرشته تار و سه تار','abstract' => 'مرشته تار و سه تار','description' => '','field_id' => 3]);
        DB::table('teachers')->insert(['pic' => 'images/teachers/eesapour.jpg','name' => 'استاد عیسی پور','title' => 'مرشته ویولن و کمانچه','abstract' => 'مرشته ویولن و کمانچه','description' => '','field_id' => 3]);
        DB::table('teachers')->insert(['pic' => 'images/teachers/zarrinkalam.jpg','name' => 'محسن زرین کلام','title' => 'مرشته گیتار کلاسیک','abstract' => 'مرشته گیتار کلاسیک','description' => '','field_id' => 3]);
        DB::table('teachers')->insert(['pic' => 'images/teachers/pourAsgari.jpg','name' => 'استاد پورعسگری','title' => 'مرشته اتوکد و نقشه کشی','abstract' => 'مرشته اتوکد و نقشه کشی','description' => '','field_id' => 1]);
        DB::table('teachers')->insert(['pic' => 'images/teachers/pahlavanyali.jpg','name' => ' استاد پهلوان یلی','title' => 'مرشته آرشیکد و 3D max','abstract' => 'مرشته آرشیکد و 3D max','description' => '','field_id' => 1]);
        DB::table('teachers')->insert(['pic' => 'images/teachers/aamer.jpg','name' => 'استاد عامر','title' => 'مرشته گیتار','abstract' => ' مرشته گیتار','description' => '','field_id' => 3]);
        ...
        DB::table('teachers')->insert(['pic' => 'images/teachers/rostami.jpg','name' => 'مهندس گوهر رستمی','title' => 'مرشته برنامه نویسی دستگاه های همراه و اندروید','abstract' => 'مرشته برنامه نویسی دستگاه های همراه و اندروید','description' => '','field_id' => 1]);
        ...
        DB::table('teachers')->insert(['pic' => 'images/teachers/hayatbakhsh.jpg','name' => 'استاد حیات بخش','title' => 'استاد خوشنویسی و تحریر','abstract' => 'مرشته رسمی انجمن خوشنویسان ایران با بیش از سی سال سابقه','description' => '<h3 class="persianFont"> فعالیت ها </h3><ul class="teacherActivity"><li><h4 class="persianFont">آموزش خط نستعلیق</h4></li><li><h4 class="persianFont">آموزش شکسته نستعلیق</h4></li><li><h4 class="persianFont">آموزش نسخ</h4></li><li><h4 class="persianFont">آموزش ثلث</h4></li><li><h4 class="persianFont">آموزش خط تحریری</h4></li></ul>','field_id' => 4]);
        ...
        DB::table('teachers')->insert(['pic' => 'images/teachers/te00.jpg','name' => 'استاد دیلمی','title' => 'مرشته سنتور','abstract' => 'مرشته سنتور','description' => '','field_id' => 3]);
        DB::table('teachers')->insert(['pic' => 'images/teachers/te00.jpg','name' => 'استاد تمیمی','title' => 'مرشته سنتور','abstract' => 'مرشته سنتور','description' => '','field_id' => 3]);
        DB::table('teachers')->insert(['pic' => 'images/teachers/te00.jpg','name' => 'استاد مرادی','title' => ' مرشته ویولن و کمانچه','abstract' => ' مرشته ویولن و کمانچه','description' => '','field_id' => 3]);
        ...
        DB::table('teachers')->insert(['pic' => 'images/teachers/te00.jpg','name' => 'استاد یوسفی','title' => 'مرشته هلو و نرم افزار های مالی','abstract' => 'مرشته هلو و نرم افزار های مالی','description' => '','field_id' => 2]);
        ...
        //add course
        DB::table('courses')->insert(['pic' => 'images/courses/icdl7.jpg','title' => 'مهارت های هفتگانه','abstract' => 'آموزش مهارت های هفتگانه ICDL با مدرک سازمان فنی و حرفه ای','information'=>'','description' => '<dl class="dlclass"><dt>مهارت های هفتگانه ICDLشامل موارد زیر است :</dt><dd><ul><li>(IT) آشنائی با مفاهیم پایه و اساسی فناوری اطلاعات</li><li>(Windows) آشنائی با شیوه استفاده از کامپیوتر ومدیریت فایلها</li><li>(Word) شیوه به کارگیری نرم افزار واژه پرداز</li><li>(Excel) شیوه کار با صفحه گسترده</li><li>(Access) شیوه استفاده از نرم افزار پایگاه داده ها</li><li>(Powerpoint) شیوه کار با نرم افزار ارائه مطلب</li><li>(Internet) اطلاعات و ارتباطات</li></ul></dd></dl>','field_id' => 1]);
        ...
        DB::table('courses')->insert(['pic' => 'images/courses/csharp.jpg','title' => 'آموزش سی شارپ','abstract' => 'دوره مقدماتی و پیشرفته با پروژه عملی','information' => '<h5><i class="glyphicon glyphicon-calendar"></i><span class="persianFont">شروع دوره: هفته اول تیرماه</span></h5><h5><i class="glyphicon glyphicon-th-list"></i><span class="persianFont">طول دوره: 10 جلسه (دوره مقدماتی)، 10 جلسه (دوره پیشرفته)</span></h5><h5><i class="glyphicon glyphicon-blackboard"></i><span class="persianFont">نوع دوره: خصوصی، نیمه خصوصی و عمومی</span></h5><h5><i class="glyphicon glyphicon-usd"></i><span class="persianFont">شهریه دوره: بنا بر نوع تشکیل کلاس ها متفاوت می باشد</span></h5>','description' => '<dl class="dlclass"><dt>بخش اول:قابلیت های کلیدی زبان #C</dt><dd><ul><li>Automatic Property ها</li><li>Object Iniatializer</li><li>Collection Initialzer</li><li>Extension Method ها</li><li>استفاده از Extension Method ها در Interface ها</li><li>Delegate ها</li></ul></dd><dt>بخش دوم :تاریخچه MVC و شروع کار با MVC</dt><dd><ul><li>تاریخچه MVC</li><li>مشکلات Asp.Net WebForm</li><li>استاندارد های وب</li><li>الگوی MVC چیست ؟</li><li>مفهوم الگوی MVC</li><li>Domain Model چیست ؟</li><li>آشنایی با Design Patern ها</li><li>Model-View</li><li>Model-View-ViewModel</li><li>Model-View-Presenter</li><li>معماری MVC</li><li>چرا باید از MVC استفاده کنیم ؟</li><li>مهاجرت از WebForms به MVC</li><li>امکانات MVC 6</li><li>آشنایی با Visual Studio 2013</li><li>قالب پروژه ها</li><li>Empty</li><li>WebForms</li><li>MVC</li><li>WebApi</li><li>Single Page Application</li><li>FaceBook</li><li>نصب MVC 6</li></ul></dd><dt>بخش سوم :کار با Controller ها</dt><dd><ul><li>معرفی کنترل ها</li><li>آماده سازی پروژه</li><li>ایجاد یک کنترلر ساده</li><li>ایجاد کنترل با ارث بری از Controller</li><li>بررسی انواع کنترل</li><li>Empty</li><li>Read/Write Actions</li><li>With Views Using Entity Framework</li><li>API 2 - Empty</li><li>API 2 With Read/Write</li><li>API 2 With Actions - Using Entity Framework</li></ul></dd><dt></dt><dd><ul></ul></dd></dl>','field_id' => 1]);
        ...
        DB::table('courses')->insert(['pic' => 'images/courses/coreldraw.jpg','title' => 'آموزش جامع کورل دراو مقدماتی و پیشرفته','abstract' => 'از قوی ترین نرم افزارهایی است که برای ایجاد و ویرایش فایل های گرافیکی برداری، طراحی لوگو، کارت ویزیت و امور مشابه استفاده می شود.','information' => '','description' => '<ul style="list-style-type: square;"><li>آشنایی با محیط و کار با ابزار Pick</li><li>کار با ابزارهای ترسیمی</li><li>کار با ابزار خط</li><li>شیوه های مختلف نمایش و مدیریت نمایش</li><li>تغییر دادن و ویرایش یک آرم رسم شده</li><li>کار با افکت ها</li><li>منوهای کاربردی</li><li>رنگ آمیزی</li></ul>','field_id' => 1]);
        ...
        DB::table('courses')->insert(['pic' => 'images/courses/khoshnevisi.jpg','title' => 'آموزش خوشنویسی','abstract' => 'توسط استاد حیات بخش','information' => '<h5><i class="glyphicon glyphicon-calendar"></i><span class="persianFont">هر هفته یک شنبه ها</span></h5><h5><i class="glyphicon glyphicon-blackboard"></i><span class="persianFont">نوع دوره: خصوصی، نیمه خصوصی و عمومی</span></h5>','description' => '','field_id' => 4]);
        //add teacher course
        DB::table('teacher_courses')->insert(['teacher_id' => 1,'course_id' =>7]);
        DB::table('teacher_courses')->insert(['teacher_id' => 1,'course_id' =>13]);
        DB::table('teacher_courses')->insert(['teacher_id' => 2,'course_id' =>2]);
        DB::table('teacher_courses')->insert(['teacher_id' => 2,'course_id' =>18]);
        DB::table('teacher_courses')->insert(['teacher_id' => 3,'course_id' =>12]);
        DB::table('teacher_courses')->insert(['teacher_id' => 4,'course_id' =>3]);
        DB::table('teacher_courses')->insert(['teacher_id' => 4,'course_id' =>8]);
        DB::table('teacher_courses')->insert(['teacher_id' => 4,'course_id' =>19]);
        DB::table('teacher_courses')->insert(['teacher_id' => 4,'course_id' =>20]);
        DB::table('teacher_courses')->insert(['teacher_id' => 4,'course_id' =>21]);
        DB::table('teacher_courses')->insert(['teacher_id' => 4,'course_id' =>22]);
        DB::table('teacher_courses')->insert(['teacher_id' => 4,'course_id' =>23]);
        DB::table('teacher_courses')->insert(['teacher_id' => 4,'course_id' =>24]);
        DB::table('teacher_courses')->insert(['teacher_id' => 5,'course_id' =>16]);
        DB::table('teacher_courses')->insert(['teacher_id' => 6,'course_id' =>9]);
        DB::table('teacher_courses')->insert(['teacher_id' => 7,'course_id' =>11]);
        DB::table('teacher_courses')->insert(['teacher_id' => 8,'course_id' =>14]);
        DB::table('teacher_courses')->insert(['teacher_id' => 11,'course_id' =>14]);
        DB::table('teacher_courses')->insert(['teacher_id' => 14,'course_id' =>25]);
        DB::table('teacher_courses')->insert(['teacher_id' => 14,'course_id' =>26]);
        DB::table('teacher_courses')->insert(['teacher_id' => 14,'course_id' =>27]);
        DB::table('teacher_courses')->insert(['teacher_id' => 14,'course_id' =>28]);
        DB::table('teacher_courses')->insert(['teacher_id' => 14,'course_id' =>29]);
        DB::table('teacher_courses')->insert(['teacher_id' => 14,'course_id' =>30]);
        DB::table('teacher_courses')->insert(['teacher_id' => 14,'course_id' =>31]);
        DB::table('teacher_courses')->insert(['teacher_id' => 15,'course_id' =>15]);
        DB::table('teacher_courses')->insert(['teacher_id' => 16,'course_id' =>7]);
        DB::table('teacher_courses')->insert(['teacher_id' => 16,'course_id' =>13]);
        DB::table('teacher_courses')->insert(['teacher_id' => 18,'course_id' =>36]);
        DB::table('teacher_courses')->insert(['teacher_id' => 23,'course_id' =>17]);
        DB::table('teacher_courses')->insert(['teacher_id' => 24,'course_id' =>10]);
        DB::table('teacher_courses')->insert(['teacher_id' => 25,'course_id' =>32]);
        DB::table('teacher_courses')->insert(['teacher_id' => 25,'course_id' =>33]);
        DB::table('teacher_courses')->insert(['teacher_id' => 25,'course_id' =>34]);
        DB::table('teacher_courses')->insert(['teacher_id' => 25,'course_id' =>35]);
