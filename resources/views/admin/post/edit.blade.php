            ...
            <form role="form" method="post"  action="{{ url('admin/post/' . $post->id) }}" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                          <img id="inputImage" onclick="$('#pic').trigger('click');" style="cursor: pointer;width: auto;height: 180px;"
                            src="{{$post->pic===''?asset('images/no-image.png'):asset($post->pic)}}" class="img-rounded" alt="no Image Available">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="abstract" name="abstract" class="form-control" placeholder="خلاصه خبر" >{{$post->abstract}}</textarea>
