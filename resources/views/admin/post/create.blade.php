        ...
        <form role="form" method="post" action="{{url('admin/post')}}" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="Name" class="control-label">تصویر خبر</label>
                    <div>
                ...
                <div class="form-group">
                    ...
                    <input id="title" name="title" class="form-control" placeholder="عنوان خبر" />
                    <span for="title" class="text-danger"></span>
                </div>

                <div class="form-group">
                    <label for="abstract" class="control-label">خلاصه خبر</label>
                    <textarea id="abstract" name="abstract" class="form-control" placeholder="خلاصه خبر" ></textarea>
                    <span for="abstract" class="text-danger"></span>
                </div>

                <div class="form-group">
                    <label for="body" class="control-label">متن خبر</label>
                    <textarea id="body" name="body" class="form-control" placeholder="درباره ی خبر" >
                    </textarea>
